...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'HtmlPageTranslation'
        db.create_table(u'fluent_pages_htmlpage_translation', (
            ...
            (u'master', self.gf('django.db.models.fields.related.ForeignKey')(related_name='seo_translations', null=True, to=orm['fluent_pages.Page'])),
        ))
        db.send_create_signal('fluent_pages', ['HtmlPageTranslation'])

        # Adding unique constraint on 'HtmlPageTranslation', fields ['language_code', u'master']
        db.create_unique(u'fluent_pages_htmlpage_translation', ['language_code', u'master_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'HtmlPageTranslation', fields ['language_code', u'master']
        db.delete_unique(u'fluent_pages_htmlpage_translation', ['language_code', u'master_id'])

        # Deleting model 'HtmlPageTranslation'
        db.delete_table(u'fluent_pages_htmlpage_translation')
    ...
    models = {
        ...
        'fluent_pages.htmlpagetranslation': {
            ...
            u'master': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'seo_translations'", 'null': 'True', 'to': "orm['fluent_pages.Page']"}),
        ...
        'fluent_pages.urlnode_translation': {
            ...
            '_cached_url': ('django.db.models.fields.CharField', [], {'max_length': '300', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'language_code': ('django.db.models.fields.CharField', [], {'max_length': '15', 'db_index': 'True'}),
